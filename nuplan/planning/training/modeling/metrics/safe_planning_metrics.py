...
class AverageDisplacementError(AbstractTrainingMetric):
    ...
    def __init__(self, name: str = 'closed_loop_avg_displacement_error') -> None:
        """
...
class FinalDisplacementError(AbstractTrainingMetric):
    ...
    def __init__(self, name: str = 'closed_loop_final_displacement_error') -> None:
        """
        Initializes the class.
...
class AverageHeadingError(AbstractTrainingMetric):
    ...
    def __init__(self, name: str = 'closed_loop_avg_heading_error') -> None:
        """
        Initializes the class.
...
class FinalHeadingError(AbstractTrainingMetric):
    ...
    def __init__(self, name: str = 'closed_loop_final_heading_error') -> None:
        """
        Initializes the class.
